...
def test_VOCSegmentationWithInteractive(root_dir, image_set='train', main_data='image'):
    transforms = TransfromsCompose([
        T.RandomHorizontalFlip(p=0.5),
        T.Resize((384, 384))
    ])
    dataset = VOCSegmentationWithInteractive(root_dir, image_set, transforms, main_data)
...
# root_dir='./voc2012'
# test_VOCSegmentationWithInteractive(root_dir, image_set='train', main_data='image')
# test_VOCSegmentationWithInteractive(root_dir, image_set='train', main_data='interactive')
# test_VOCSegmentationWithInteractive(root_dir, image_set='val', main_data='image')
# test_VOCSegmentationWithInteractive(root_dir, image_set='val', main_data='interactive')
...
# dataset = VOCSegmentationWithInteractive(voc2012_dir, image_set='train', main_data='image')
# image, label, fg_interactive, bg_interactive, image_name = dataset[0]
